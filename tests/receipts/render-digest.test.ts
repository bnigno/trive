...
const full: DailyDigestData = {
  ...
  bot: { conversations: 6, turns: 19, handoffs: 1, orders: 2, ordersCents: 57800, costUsdCents: 42, studioImages: 9, studioVideos: 0, studioUsdCents: 99 },
  lowStock: [
...
const empty: DailyDigestData = {
  ...
  bot: { conversations: 0, turns: 0, handoffs: 0, orders: 0, ordersCents: 0, costUsdCents: 0, studioImages: 0, studioVideos: 0, studioUsdCents: 0 },
  lowStock: [],
  bestSeller: null,
    editions: [],
};
