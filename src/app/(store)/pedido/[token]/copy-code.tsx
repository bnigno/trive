...
const copyButton =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-(--radius-hair) border border-ink-900/80 px-5 py-2.5 font-store text-xs font-medium uppercase tracking-[0.16em] text-ink-900 transition-colors duration-300 ease-silk hover:border-gold-600 hover:bg-gold-600 hover:text-ivory-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-600";
