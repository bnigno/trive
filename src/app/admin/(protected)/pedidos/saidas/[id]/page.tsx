              ...
              <li key={stop.id} className="flex flex-col gap-2 py-4 first:pt-0 last:pb-0">
                ...
                {stop.status === "failed" ? (
                  <p className="text-sm text-red-700 dark:text-red-300">
                    ...
                    {stop.failureNote ? ` — "${stop.failureNote}"` : ""}. O pedido continua como saído: combine com a cliente e reagende na Rota do dia (ou, se sai de novo hoje, marque &ldquo;Levar nesta saída&rdquo;).
                  </p>
                ) : null}
