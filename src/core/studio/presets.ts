// A casa do ensaio: cenas, modelas e corpos são listas FIXAS em código — a
// mesma modela, na mesma cena, em toda a edição é o que dá consistência de
...
// a dona vê no painel.
//
// Nenhuma modela é parecida com pessoa real, e nunca se usa rosto ou corpo
