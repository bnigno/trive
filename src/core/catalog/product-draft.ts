...
export const PRODUCT_DRAFT_JSON_SCHEMA: Record<string, unknown> = {
  type: "object",
  properties: {
    name: { type: "string", description: "Nome da peça no tom da loja, até 80 caracteres." },
    categorySlug: {
      type: ["string", "null"],
