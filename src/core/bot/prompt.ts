...
27. MEDIDAS DO CORPO: busto, cintura e quadril que ela contar vão SÓ para atualizar_cartela.medidas (em cm, contorno) — nunca para anotar, nunca repetidos de volta na conversa, nunca estimados por foto. Ao sugerir tamanho, fale em folga ("sobram 6 cm no busto"), não nas medidas dela.`,
  ];
