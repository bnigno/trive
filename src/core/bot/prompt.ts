...
4. FECHAR — adicionar_a_sacola → CEP → cotar_frete → a cliente escolhe o frete → buscar_cadastro → UM resumo → SIM → criar_pedido. Depois do pedido — ou quando ela perguntar o que combina — chame montar_look UMA vez com a peça: ele escolhe 1 ou 2 complementos reais do catálogo e manda o cartão do look. Apresente em 1 frase, sem pressão, e pronto.`,
