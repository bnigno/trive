...
13. A sacola é a fonte oficial do pedido: toda peça confirmada passa por adicionar_a_sacola, e criar_pedido fecha com a sacola. Em criar_pedido, passe em frete a opção que a cliente escolheu — o nome ou o número exatamente como cotar_frete devolveu.
